...
def get_args():
    ...
    parser.add_argument('--config', type=str, default='configs/HierText.yaml')
    # parser.add_argument('--local_rank', type=int, default=0)
    # parser.add_argument("--ngpus", default=1, type=int)
    args = parser.parse_args()
    cfg_tmp = Config.fromfile(args.config)
    cfg = CfgNode.load_yaml_with_base(args.config, allow_unsafe=True)    
    cfg.update(cfg_tmp.__dict__.items())
